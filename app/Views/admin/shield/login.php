...
<div class="d-flex justify-content-center p-5">
    <form action="<?= url_to('login') ?>" class="form_container" method="post">
        <?= csrf_field() ?>
        <div class="logo_container d-flex align-items-center justify-content-center overflow-hidden">
            <img src="https://logowik.com/content/uploads/images/651_codeigniter.jpg" style="width: 100px;height: auto;">
        </div>
        <div class="title_container">
            <p class="title"><?= lang('Auth.login') ?></p>
        ...
        <div class="input_container">
            <label class="input_label" for="email_field"><?= lang('Auth.email') ?></label>
            ...
            <input inputmode="email" autocomplete="email" placeholder="<?= lang('Auth.email') ?>" value="<?= old('email') ?>" type="email" class="input_field" id="email_field" name="email">
        </div>
        <div class="input_container">
            <label class="input_label" for="password_field"><?= lang('Auth.password') ?></label>
            <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
            ...
            <input placeholder="Password" name="password" type="password" class="input_field" id="password_field" inputmode="text" autocomplete="current-password" placeholder="<?= lang('Auth.password') ?>">
        </div>
        <div>
            <!-- Remember me -->
